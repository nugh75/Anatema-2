...
class DiaryEntry(db.Model):
    ...
    def get_activity_type_display(self):
        """Restituisce il display name per il tipo di attività"""
        types = {
            'general': 'Generale',
            'meeting': 'Riunione',
            'milestone': 'Milestone',
        ...
        return types.get(self.activity_type, self.activity_type.title())
    
    def get_status_display(self):
        """Restituisce il display name per lo stato"""
        statuses = {
            'active': 'Attivo',
    ...
    def get_priority_display(self):
        """Restituisce il display name per la priorità"""
        priorities = {
            'low': 'Bassa',
            'medium': 'Media',
            'high': 'Alta',
